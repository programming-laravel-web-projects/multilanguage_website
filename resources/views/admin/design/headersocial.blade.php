      ...
      <div class="card">
        ...
        <div class="card-body">
                           ...
                           <div class="col-lg-12  form-separate ">
                            <form class="form-horizontal" name="add_social_form" method="POST" action="{{url('admin/design/addheadsocial')}}" 
        ...
        <table id="example1" class="table table-bordered table-striped table-hover">
                ...
                <tr>
                  ...
                  <td>    
                          <form action="{{url('admin/design/delheadsocial',$item->id)}}" method="POST" class="d-inline">
                            @csrf
                            @method('DELETE')
