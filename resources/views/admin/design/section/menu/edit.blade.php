                                        ...
                                        <div class="card card-primary card-outline card-outline-tabs">
                                            ...
                                            <div class="card-body">
                                                <div class="tab-content" id="custom-tabs-four-tabContent">
                                                    <div class="tab-pane fade @if ($item->code == 'catalog') show active @endif"
                                                        id="custom-tabs-four-pdf" role="tabpanel"
                                                        aria-labelledby="custom-tabs-four-pdf-tab">
                                                    ...
                                                    {{-- image content --}}
                                                    <div class="tab-pane fade  @if ($item->code != 'catalog') show active @endif "
                                                        id="custom-tabs-four-images" role="tabpanel"
                                                        aria-labelledby="custom-tabs-four-images-tab">
                                                    ...
                                                    <div class="tab-pane fade" id="custom-tabs-four-video"
                                                        role="tabpanel" aria-labelledby="custom-tabs-four-video-tab">
                                                        <!-- Video -->
                                                        <div class="card-header">
                                                            <h3 class="card-title"></h3>
                                                            <div class="card-tools">
                                                                <button type="button" class="btn btn-info btn-sm"
                                                                    data-toggle="modal" data-target="#modal-newvid"
                                                                    id="btn-new-vid">
                                                                    <i class="fas fa-plus">
                                                                    </i>
                                                                    New
                                                            ...
                                                            @foreach ($item->mediaposts->where('media_type', 'video') as $itemimage)
                                                                <div class="col-sm-2">
                                                                    <div class="image-contain">
                                                                        ...
                                                                        <video controls class="img-fluid mb-2 image-show"
                                                                            alt="{{ $itemimage->mediastore->caption }}">
                                                                            <source
                                                                                src="{{ $itemimage->mediastore->image_path }}">
                                                                        </video>
                                                                        <input id="edit-{{ $itemimage->mediastore->id }}"
                                                                            class="btn btn-xs btn-primary update-video "
                                                                            type="button" value="Edit"
                                                                            data-toggle="modal"
                                                                            data-target="#modal-edit-video">
                                                                        <input id="del-{{ $itemimage->mediastore->id }}"
                                                                            class="btn btn-xs btn-danger delete-video "
                                                                            type="button" value="Delete"
                                                                            data-toggle="modal"
                                                                            data-target="#modal-delete">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group row">
                                <form class="form-horizontal col-sm-12" name="update_video_form" method="POST"
                                    action="{{ route('mediapost.updatevideo', 'item_Id') }}"
