    ...
    <section class="content">
      ...
      <div class="card">
        <div class="card-header">
          ...
          <a class="btn btn-info btn-sm" href="{{url('admin/setting/createsocial')}}">
                              <i class="fas fa-plus">
                              </i>
                             New
                          </a>
        ...
        <table id="example1" class="table table-bordered table-striped table-hover">
                ...
                <tr>
                  ...
                  <td>    <a class="btn btn-info btn-sm" href="{{url('admin/setting/editsocial',$item->id)}}">
                              <i class="fas fa-pencil-alt">
                              </i>
                              Edit
                          </a>
                          <form action="{{url('admin/setting/delsocial',$item->id)}}" method="POST" class="d-inline">
                            @csrf
                            @method('DELETE')
