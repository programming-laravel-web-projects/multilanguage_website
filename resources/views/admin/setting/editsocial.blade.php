        ...
        <section class="content">
            ...
            <div class="card card-info">
                <div class="card-header">
                    <h3 class="card-title">Edit Social</h3>
                </div>
                <!-- Title start -->
                <div class="card-body  row">
                    <div class="col-lg-12">
                        <form class="form-horizontal" name="create_social_form" method="POST" action="{{url('admin/setting/updatesocial', $item->id)}}" 
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control " name="code" id="code"
                                        placeholder="Code" value="{{ $item->value1 }}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control " name="link" id="link"
                                        placeholder="Link" value="{{ $item->value3 }}">
